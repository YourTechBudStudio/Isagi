export { WorkspaceError, WorkspaceService, WorkspaceServiceLive } from './workspace.service.js';
...
export type { WorkspaceRepositoryService } from './workspace.repository.js';
