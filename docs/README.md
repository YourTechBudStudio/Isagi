...
8. [`milestone-guidance.md`](./milestone-guidance.md) — how milestones and stories are represented on GitHub Issues, retrieved, and amended
...
- **Milestone Guidance**: the GitHub Issues mapping for milestones and stories — labels, the sub-issue relationship, append-only amendments, retrieval, and the publication flow.
