...
| `0009-explicit-retry-agent-turn-recovery.md`                | accepted | workflow Retry; human-authorized replacement turns; agent-response recovery; completion and response identity                                                                                                                  |
